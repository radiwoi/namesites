...
//      backend_url: "http://names_project.devhost1.com/api/v1/"
  ...
  methods: {
    ...
    getRequestData(){
      ...
      let url = (this.currentPage == 'search-page') ? this.backend_url + this.urlsMapper[this.currentPage] + "/?limit=" + this.searchObject.limit + "&offset=" + this.searchObject.skip  + "&is_girl_name=True" : this.backend_url + this.urlsMapper[this.currentPage] + "/?limit=10000&offset=0&is_girl_name=True";
      let requestData = {
        "postData": postData,
        "url": url
      };
